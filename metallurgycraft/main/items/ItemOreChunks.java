...
public class ItemOreChunks extends Item {

	private String tipText;
	
	public ItemOreChunks(int id, int textureId, String itemName, int maxStackSize, String tipText) {
		super(id-256);
		/**
		 * Registra pezzi di minerali
