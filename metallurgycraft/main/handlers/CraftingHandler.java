...
public class CraftingHandler {
	...
	public static void initCrafting() {
		...
		GregtechCompat.addAlloySmelterRecipe(GregtechCompat.getGregTechItem(2, 1, 33), null, new ItemStack(Items.burntLimeCell, 1), 20, 120);
		GregtechCompat.addElectrolyzerRecipe(GregtechCompat.getGregTechItem(1, 64, 241), 0, new ItemStack(Items.mixedIronOxides, 16), null, null, null, 20, 120);
		...
		if (magnetite != null && hematite != null && goethite != null && siderite != null && cellOxygen != null) {
			...
			GregtechCompat.addElectrolyzerRecipe(new ItemStack(Items.mixedIronOxides, 64), 0, magnetite, hematite, goethite, siderite, 60, 400);
			
			magnetite.stackSize = 1;
			cellOxygen.stackSize = 4;
			GregtechCompat.addElectrolyzerRecipe(magnetite, 4, new ItemStack(Items.purifiedIronOre, 3), cellOxygen, null, null, 40, 90);
			
			hematite.stackSize = 1;
			cellOxygen.stackSize = 3;
			GregtechCompat.addElectrolyzerRecipe(hematite, 3, new ItemStack(Items.purifiedIronOre, 2), cellOxygen, null, null, 40, 90);
			
			goethite.stackSize = 1;
			cellOxygen.stackSize = 3;
			waterCell.stackSize = 2;
			GregtechCompat.addElectrolyzerRecipe(goethite, 3, new ItemStack(Items.purifiedIronOre, 1), cellOxygen, waterCell, null, 40, 90);
		...
		GregtechCompat.addChemicalRecipe(new ItemStack(Items.purifiedIronOre), new ItemStack(Items.burntLimeCell), new ItemStack(Items.limedIronOre), 5);
		RailcraftCraftingManager.blastFurnace.addRecipe(Items.limedIronOre.itemID, 100, new ItemStack(Items.ingotPigIron));
		
		ItemStack cellLiquidOxygen = CraftingHelpers.getOreDict("cellLiquidOxygen");

		if (cellLiquidOxygen != null) {
			GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotPigIron), cellLiquidOxygen, new ItemStack(Items.ingotImpureMildSteel), null, 80, 3300, 1900);
		}
		
		
		// METALLURGIA SECONDARIA
		
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotImpureMildSteel), GregtechCompat.getGregTechItem(2, 1, 15), new ItemStack(Items.ingotDegassedMildSteel), null, 50, 600, 1300);
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotDegassedMildSteel), null, new ItemStack(Items.ingotDesulfuredSteel), null, 50, 600, 1300);
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotDesulfuredSteel), null, new ItemStack(Items.ingotMildSteel), null, 50, 600, 1300);
		
		GregtechCompat.addChemicalRecipe(GregtechCompat.getGregTechItem(1, 4, 20), GregtechCompat.getGregTechItem(1, 4, 28), new ItemStack(Items.dust17NiCrMoMix), 20);
		GregtechCompat.addChemicalRecipe(GregtechCompat.getGregTechItem(1, 8, 22), GregtechCompat.getGregTechItem(1, 4, 20), new ItemStack(Items.dustHSS18Mix), 20);
		GregtechCompat.addChemicalRecipe(GregtechCompat.getGregTechItem(1, 2, 22), GregtechCompat.getGregTechItem(1, 8, 28), new ItemStack(Items.dustAISI316Mix), 20);
		GregtechCompat.addChemicalRecipe(GregtechCompat.getGregTechItem(1, 8, 240), GregtechCompat.getGregTechItem(1, 8, 12), new ItemStack(Items.dustC45Mix), 20);
		
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotMildSteel), new ItemStack(Items.dust17NiCrMoMix, 1), new ItemStack(Items.ingot17NiCrMo, 1), null, 60, 800, 1770);
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotMildSteel), new ItemStack(Items.dustHSS18Mix, 1), new ItemStack(Items.ingotHSS18, 1), null, 60, 800, 1770);
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotMildSteel), new ItemStack(Items.dustAISI316Mix, 1), new ItemStack(Items.ingotAISI316, 1), null, 80, 400, 1770);
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotMildSteel), new ItemStack(Items.dustC45Mix, 1), new ItemStack(Items.ingotC45, 1), null, 60, 800, 1770);
		...
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingot17NiCrMo), null, new ItemStack(Items.billet17NiCrMo), null, 20, 256, 1770);
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotAISI316), null, new ItemStack(Items.billetAISI316), null, 20, 256, 1770);
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotHSS18), null, new ItemStack(Items.billetHSS18), null, 20, 256, 1770);
		GregtechCompat.addBlastRecipe(new ItemStack(Items.ingotC45), null, new ItemStack(Items.billetC45), null, 20, 256, 1770);
		...
		if (mineralOilCell != null && acetyleneCell != null) {
			mineralOilCell.stackSize = 1;
			acetyleneCell.stackSize = 1;
			ItemStack rubber = ic2.api.Items.getItem("rubber").copy();
			rubber.stackSize = 4;
			GregtechCompat.addAssemblerRecipe(new ItemStack(Items.plateHSS18, 8), mineralOilCell, new ItemStack(Items.hssMachiningTool, 64), 40, 40);
			GregtechCompat.addAssemblerRecipe(new ItemStack(Items.plateHSS18, 8), acetyleneCell, new ItemStack(Items.oxyFuelWeldingKit), 40, 40);
		...
		GregtechCompat.addAssemblerRecipe(new ItemStack(Items.plate17NiCrMo, 4), new ItemStack(Items.hssMachiningTool), new ItemStack(Items.plate17NiCrMo, 4), 120, 6);
		GregtechCompat.addAssemblerRecipe(new ItemStack(Items.plateHSS18, 4), new ItemStack(Items.hssMachiningTool), new ItemStack(Items.holedPlateHSS18, 4), 120, 6);
